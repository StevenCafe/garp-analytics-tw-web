...
export const tradingDates = ["2026-08-14", "2026-08-17", "2026-08-18", "2026-08-19", "2026-08-20", "2026-08-21", "2026-08-24"];
...
const companies = {
  ...
  "3017": { name:"奇鋐", industry:"散熱", eps:[10.3,13.67,16.92,20.17,24.37], revenue25:29594509000, revenue26:49120964000, operatingIncome:13477619000, equity:62125638000, assets:194577196000, cfo:26290591000, capex:-7111878000, pb:15.65, dividendYield:.95 },
  "2313": { name:"華通", industry:"PCB", eps:[.7,1.81,1.9,1.26,1.24], revenue25:18200497000, revenue26:19991968000, operatingIncome:1951512000, equity:48578428000, assets:100923381000, cfo:834351000, capex:-3662055000, pb:5.20, dividendYield:1.32 },
  "2308": { name:"台達電", industry:"電源與能源", eps:[5.37,7.16,6.67,7.91,9.68], revenue25:124035086000, revenue26:183256080000, operatingIncome:30570042000, equity:350224892000, assets:754433332000, cfo:63100603000, capex:-27252368000, pb:12.91, dividendYield:.67 },
  "2344": { name:"華邦電", industry:"記憶體", eps:[-.29,.65,.76,2.25,5.4], revenue25:21017957000, revenue26:59843265000, operatingIncome:28979336000, equity:173542517000, assets:293034319000, cfo:35672052000, capex:-8088053000, pb:4.02, dividendYield:.32 },
  "2059": { name:"川湖", industry:"AI 伺服器", eps:[6.45,33.55,36.88,36.58,74.38], revenue25:4228734000, revenue26:10830041000, operatingIncome:8889796000, equity:33753838000, assets:47110680000, cfo:5773574000, capex:-483040000, pb:22.28, dividendYield:.65 },
  "2383": { name:"台光電", industry:"PCB", eps:[10.02,11.19,10.44,14.9,27.55], revenue25:22507694000, revenue26:47275194000, operatingIncome:12733683000, equity:58312077000, assets:158577444000, cfo:5044825000, capex:-10679228000, pb:27.62, dividendYield:.56 },
} as const;

const prices: Record<keyof typeof companies, number[]> = {
  "6669":[6435,6620,6400,6375,6325,6255,6300], "2458":[144.5,144.5,141,145.5,146,140.5,139],
  "3533":[1720,1700,1625,1620,1610,1595,1610], "3665":[2200,2135,2240,2200,2250,2275,2050],
  "3017":[3235,3150,3035,3095,2985,2865,2855], "2313":[215.5,211,211,207.5,217.5,213.5,212.5],
  "2308":[1885,1885,1820,1765,1745,1750,1735], "2344":[183.5,181.5,176.5,168,176.5,181,177],
  "2059":[12500,13750,14370,14095,13925,13385,14410], "2383":[6165,6350,6205,5880,5985,5680,5430],
};

// The stored P/B values are anchored to the official 2026-07-17 closes.
// Keep this reference fixed so retained snapshots do not change when the rolling window advances.
const pbReferencePrices: Record<keyof typeof companies, number> = {
  "6669":4620, "2458":164.5, "3533":1865, "3665":1765, "3017":2200,
  "2313":212, "2308":1740, "2344":155, "2059":7890, "2383":4495,
};

// Preserve each retained snapshot as it was knowable on that date. Newly filed
// Q2 statements affect only snapshots on or after their availability date.
function companyForDate(ticker:keyof typeof companies, dateIndex:number) {
  if(tradingDates[dateIndex]<"2026-07-31"&&ticker==="2308") return { name:"台達電", industry:"電源與能源", eps:[3.94,5.37,7.16,6.67,7.91] as const, revenue25:118919406000, revenue26:159352652000, operatingIncome:28417303000, equity:357259207000, assets:684173975000, cfo:19931192000, capex:-11091192000, pb:15.09, dividendYield:.67 };
  if(tradingDates[dateIndex]<"2026-07-31"&&ticker==="2383") return { name:"台光電", industry:"PCB", eps:[10.01,10.02,11.19,10.44,14.9] as const, revenue25:21680064000, revenue26:33067261000, operatingIncome:7128470000, equity:47920935000, assets:130976723000, cfo:2703047000, capex:-5663623000, pb:33.59, dividendYield:.56 };
  ...
  if(tradingDates[dateIndex]<"2026-08-17"&&ticker==="3533") return { name:"嘉澤", industry:"電子零組件", eps:[20.22,6.69,20.71,22.53,21.37] as const, revenue25:7765494000, revenue26:9327579000, operatingIncome:2708466000, equity:44011578000, assets:54367736000, cfo:2125315000, capex:-1510588000, pb:4.99, dividendYield:1.87 };
...
function buildSnapshots(): Record<string,DailySnapshot> {
  ...
  tradingDates.forEach((date,dateIndex)=>{
    ...
    const stocks=candidates.map(({ticker,price,f},index):DailyStockAnalysis=>{
      ...
      const hasQ2Results=(date>="2026-07-31"&&(ticker==="2308"||ticker==="2383"))||(date>="2026-08-06"&&(ticker==="2344"||ticker==="2059"))||(date>="2026-08-10"&&(ticker==="6669"||ticker==="2313"))||(date>="2026-08-13"&&ticker==="3017")||(date>="2026-08-14"&&ticker==="2458")||(date>="2026-08-17"&&ticker==="3533");
...
export const dataSources=[
  {name:"臺灣證券交易所",scope:"2026/8/14–8/24 每日收盤價；最新可得 P/E、P/B、殖利率",url:"https://www.twse.com.tw/"},
  {name:"公開資訊觀測站",scope:"2025 Q1–2026 Q2 合併財務報表；除貿聯-KY 外，追蹤池其餘公司均已更新至 2026 Q2",url:"https://mops.twse.com.tw/"},
