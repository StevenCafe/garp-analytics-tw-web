...
export const tradingDates = ["2026-09-10", "2026-09-11", "2026-09-14", "2026-09-15", "2026-09-16", "2026-09-17", "2026-09-18"];
...
const prices: Record<keyof typeof companies, number[]> = {
  "6669":[2345,2310,2270,2315,2165,2135,2140], "2458":[128,126.5,126.5,125,128.5,129,132],
  "3533":[1575,1580,1590,1520,1510,1555,1585], "3665":[1930,1875,1955,1980,1995,2010,2210],
  "3017":[3460,3370,3310,3115,3175,3185,3430], "2313":[225.5,221.5,221,218.5,225,218.5,228.5],
  "2308":[1675,1620,1620,1670,1710,1685,1735], "2344":[179.5,171.5,160,159.5,169,170,179.5],
  "2059":[12600,12080,11990,11715,12045,12295,12495], "2383":[5375,5365,5345,5115,5085,4695,4890],
};
...
function companyForDate(ticker:keyof typeof companies, dateIndex:number) {
  ...
  if(tradingDates[dateIndex]<"2026-08-25"&&ticker==="3665") return { name:"貿聯-KY", industry:"電子零組件", eps:[8.49,10.54,13.51,14.08,11.66] as const, revenue25:16120785000, revenue26:20863649000, operatingIncome:3108361000, equity:46636528000, assets:85600663000, cfo:250919000, capex:-840105000, pb:7.38, dividendYield:.86 };
...
export const dataSources=[
  {name:"臺灣證券交易所",scope:"2026/9/10–9/18 每日收盤價；最新可得 P/E、P/B、殖利率；緯穎 9/2 除權資料",url:"https://www.twse.com.tw/"},
